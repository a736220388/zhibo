...
//    UIImage *inverImage = [invertFilter imageByFilteringImage:[UIImage imageNamed:@"bg_zbfx"]];
//    self.backgroundView.image = inverImage;
//    //怀旧
//    GPUImageSepiaFilter *sepiaFilter = [[GPUImageSepiaFilter alloc]init];
//    UIImage *sepiaImage = [sepiaFilter imageByFilteringImage:[UIImage imageNamed:@"bg_zbfx"]];
//    self.backgroundView.image = sepiaImage;
}
